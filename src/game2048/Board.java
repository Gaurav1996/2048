...
public class Board extends Group {
    ...
    private void createScore() {
        ...
        Label lblSubtitle = new Label("JavaFX");
    ...
    private void initGameProperties() {
        ...
        gameAboutProperty.addListener((observable, oldValue, newValue) -> {
            if (newValue) {
                ...
                link2.setText("Bruno Ramalhete");
                link2.setOnAction(e->hostServices.showDocument("https://www.github.com/Spectrum256"));
                ...
                /*
                link3.setText("testhyperlink");
                link3.setOnAction(e->hostServices.showDocument(" "));
                Text t32 = new Text(" & ");
